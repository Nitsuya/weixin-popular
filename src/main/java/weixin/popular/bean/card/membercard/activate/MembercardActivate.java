...
/**
 * 微信卡券－会员卡专区－创建会员卡-接口激活-请求参数
 * @author Nitsuya
 */
public class MembercardActivate {
    ...
    /** 商家自定义会员卡背景图，须先调用上传图片接口将背景图上传至CDN，否则报错，卡面设计请遵循微信会员卡自定义背景设计规 */
    @JSONField(name = "background_pic_url")
    private String backgroundPicUrl;

    /** 激活后的有效起始时间。若不填写默认以创建时的data_info为准。Unix时间戳格式 */
    @JSONField(name = "activate_begin_time")
    private Integer activateBeginTime;

    /** 激活后的有效截至时间。若不填写默认以创建时的data_info为准。Unix时间戳格式 */
